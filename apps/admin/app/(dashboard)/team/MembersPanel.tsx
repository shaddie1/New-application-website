...
/** Add and remove staff — the owner's tab on the Team page. */
export function MembersPanel() {
  ...
  return (
    <div className="space-y-8">
      <p className="text-text-muted text-sm">Add or remove admins and support staff. Only you (owner) can do this.</p>
      ...
      <form onSubmit={add} className="rounded-xl border border-border bg-surface p-5">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <option value="BUSINESS_DEVELOPMENT_LEAD">Business Development Lead</option>
          </select>
          <button
            type="submit"
            disabled={busy}
